...
#ifndef modelLoader_2eproto_2epb_2eh
#define modelLoader_2eproto_2epb_2eh
...
#define PROTOBUF_INTERNAL_EXPORT_modelLoader_2eproto
...
struct TableStruct_modelLoader_2eproto {
...
/* @@protoc_insertion_point(class_definition:ModelRequest) */ {
 ...
 private:
  ...
  union { Impl_ _impl_; };
  friend struct ::TableStruct_modelLoader_2eproto;
};
// -------------------------------------------------------------------
...
#endif  // modelLoader_2eproto_2epb_2eh
