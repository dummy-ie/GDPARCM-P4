...
SceneLoader::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel, const ::grpc::StubOptions& options)
  : channel_(channel), rpcmethod_GetModel_(SceneLoader_method_names[0], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_GetScene_(SceneLoader_method_names[1], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  {}

::grpc::Status SceneLoader::Stub::GetModel(::grpc::ClientContext* context, const ::ModelRequest& request, ::ModelReply* response) {
  return ::grpc::internal::BlockingUnaryCall< ::ModelRequest, ::ModelReply, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), rpcmethod_GetModel_, context, request, response);
}

void SceneLoader::Stub::async::GetModel(::grpc::ClientContext* context, const ::ModelRequest* request, ::ModelReply* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall< ::ModelRequest, ::ModelReply, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_GetModel_, context, request, response, std::move(f));
}

void SceneLoader::Stub::async::GetModel(::grpc::ClientContext* context, const ::ModelRequest* request, ::ModelReply* response, ::grpc::ClientUnaryReactor* reactor) {
...
::grpc::ClientAsyncResponseReader< ::ModelReply>* SceneLoader::Stub::PrepareAsyncGetModelRaw(::grpc::ClientContext* context, const ::ModelRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderHelper::Create< ::ModelReply, ::ModelRequest, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), cq, rpcmethod_GetModel_, context, request);
}

::grpc::ClientAsyncResponseReader< ::ModelReply>* SceneLoader::Stub::AsyncGetModelRaw(::grpc::ClientContext* context, const ::ModelRequest& request, ::grpc::CompletionQueue* cq) {
  auto* result =
...
SceneLoader::Service::Service() {
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      new ::grpc::internal::RpcMethodHandler< SceneLoader::Service, ::ModelRequest, ::ModelReply, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(
          [](SceneLoader::Service* service,
...
::grpc::Status SceneLoader::Service::GetModel(::grpc::ServerContext* context, const ::ModelRequest* request, ::ModelReply* response) {
  (void) context;
  (void) request;
  (void) response;
